...
export default class ElizaBot {
    ...
    _init() {
        ...
        if ((!this.elizaData.elizaKeywords)
    ...
    _postTransform(s) {
        ...
        if ((this.elizaData.elizaPostTransforms) && (this.elizaData.elizaPostTransforms.length)) {
            for (var i = 0; i < this.elizaData.elizaPostTransforms.length; i += 2) {
                s = s.replace(this.elizaData.elizaPostTransforms[i], this.elizaData.elizaPostTransforms[i + 1]);
                this.elizaData.elizaPostTransforms[i].lastIndex = 0;
            }
        }
    ...
    _getRuleIndexByKey(key) {
        for (var k = 0; k < this.elizaData.elizaKeywords.length; k++) {
            if (this.elizaData.elizaKeywords[k][0] == key)
                return k;
        }
        return -1;
    }
...
// eof
//# sourceMappingURL=elizabot.js.map